...
export const ModulesList = () => {
    ...
    return (
        <div className="col-span-full flex flex-col">
            ...
            <div className="overflow-hidden flex flex-col gap-4 mmt-6">
                {fields.map((field, index) => (
                    <div className="w-full grid grid-cols-[40px_1fr] items-center bg-muted/50 rounded-md overflow-hidden border border-input" key={field.id}>
